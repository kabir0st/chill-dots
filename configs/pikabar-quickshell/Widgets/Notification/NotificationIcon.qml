...
Item {
    ...
    Item {
        ...
        Text {
            ...
            property bool hasUnread: shell && shell.notificationHistoryWin && shell.notificationHistoryWin.hasUnread
            color: {
                if (root.isSilence)
                    return IconPalette.inactive;
                if (hasUnread)
                    return mouseAreaBell.containsMouse ? IconPalette.hover(IconPalette.notify) : IconPalette.notify;
                return mouseAreaBell.containsMouse ? Theme.textPrimary : Theme.textDisabled;
            }
