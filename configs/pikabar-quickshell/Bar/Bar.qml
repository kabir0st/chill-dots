            ...
            Item {
                ...
                PanelWindow {
                    ...
                    Rectangle {
                        ...
                        color: Qt.rgba(Theme.backgroundPrimary.r, Theme.backgroundPrimary.g, Theme.backgroundPrimary.b, Math.max(0, Math.min(1, Settings.settings.barOpacity)))
                        ...
                        // Hairline under the bar so it stays defined against bright wallpapers
                        Rectangle {
                            anchors.left: parent.left
