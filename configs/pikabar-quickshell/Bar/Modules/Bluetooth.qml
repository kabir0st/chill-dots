...
Item {
    ...
    property color statusColor: {
        if (!Bluetooth.defaultAdapter || !Bluetooth.defaultAdapter.enabled)
            return IconPalette.inactive;
        if (hasConnectedDevices)
            return IconPalette.bluetoothConnected;
        return IconPalette.bluetoothOn;
    }
        ...
        Text {
            ...
            color: mouseAreaBluetooth.containsMouse ? IconPalette.hover(bluetoothIcon.statusColor) : bluetoothIcon.statusColor
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        ...
                                        font.family: "Material Symbols Outlined"
                                        font.pixelSize: 18 * Theme.scale(Screen)
                                        color: deviceMouseArea.containsMouse ? (Settings.settings.lightMode ? Theme.textPrimary : Theme.backgroundPrimary) : (modelData.connected ? Theme.accentPrimary : Theme.textSecondary)
                                    }
                                    ...
                                    ColumnLayout {
                                        ...
                                        Text {
                                            ...
                                            color: deviceMouseArea.containsMouse ? (Settings.settings.lightMode ? Theme.textPrimary : Theme.backgroundPrimary) : (modelData.connected ? Theme.accentPrimary : Theme.textPrimary)
