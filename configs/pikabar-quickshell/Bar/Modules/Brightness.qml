...
Item {
    ...
    PillIndicator {
        id: pill
        icon: brightness >= 66 ? "brightness_high" : (brightness >= 33 ? "brightness_medium" : "brightness_low")
        text: brightness >= 0 ? brightness + "%" : "--"
        pillColor: Theme.surfaceVariant
        iconCircleColor: IconPalette.brightness
        iconTextColor: Theme.backgroundPrimary
        textColor: IconPalette.brightness
        collapsedIconColor: IconPalette.brightness
        MouseArea {
            anchors.fill: parent
            hoverEnabled: true
            onEntered: {
